...
export default function GoalsScreen() {
  ...
  const formatShoppingListText = () => {
    ...
    let listText = '🛒 Humngry Shopping List\n\n';
    Object.entries(shoppingList).forEach(([ingredient, measures]) => {
      listText += `• ${ingredient} - ${measures.join(', ')}\n`;
    });
    listText += '\n📱 Generated by Humngry';
    return listText;
  };
        ...
        <ScrollView contentContainerStyle={styles.content}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'flex-start' }}>
            <View style={{ flex: 1, maxWidth: '75%' }}>
              <Text style={[styles.title, { fontSize: getFontSize(28), color: colors.text }]}>🎯 Goals & Quests</Text>
              ...
              <View style={styles.levelHeader}>
                ...
                <View style={styles.levelBadge}>
                  <Text style={styles.levelBadgeEmoji}>
                    {levelInfo.currentLevel >= 15 ? '👑' : levelInfo.currentLevel >= 10 ? '⚡' : levelInfo.currentLevel >= 5 ? '🔥' : '⭐'}
                  </Text>
                </View>
              </View>
                  ...
                  <View style={styles.questSummary}>
                    <View>
                      ...
                      <Text style={[styles.questSummarySubtitle, { fontSize: getFontSize(14), color: colors.textSecondary }]}>
                        🏆 {totalQuestPoints} points earned today
                      </Text>
                    </View>
                    <Text style={styles.questSummaryEmoji}>
                      {completedQuests === dailyQuests.length ? '🎉' : '⚔️'}
                    </Text>
                  </View>
                </Card.Content>
              </Card>
                  ...
                  <Card.Content>
                    <View style={styles.questCard}>
                      ...
                      <View style={styles.questRight}>
                        {quest.completed ? (
                          <Text style={styles.questCompletedBadge}>✓</Text>
                        ) : (
              ...
              <Card style={[styles.card, { backgroundColor: colors.surfaceVariant }]}>
                <Card.Content>
                  <Text style={[styles.questTip, { fontSize: getFontSize(13), color: colors.text }]}>
                    💡 Complete all quests to earn bonus rewards and level up faster!
                  </Text>
                </Card.Content>
              </Card>
            </>
          ...
          <Card style={styles.card}>
            <Card.Title title="📊 Today's Progress" titleStyle={[styles.cardTitle, { fontSize: getFontSize(18) }]} />
            <Card.Content>
              <View style={styles.progressItem}>
                <View style={styles.progressHeader}>
                  <Text style={[styles.progressLabel, { fontSize: getFontSize(15) }]}>🔥 Calories</Text>
              ...
              <View style={styles.progressItem}>
                <View style={styles.progressHeader}>
                  <Text style={[styles.progressLabel, { fontSize: getFontSize(15) }]}>💪 Protein</Text>
                  <Text style={[styles.progressValue, { fontSize: getFontSize(15), color: accentColor }]}>
              ...
              <View style={styles.progressItem}>
                <View style={styles.progressHeader}>
                  <Text style={[styles.progressLabel, { fontSize: getFontSize(15) }]}>💧 Water</Text>
                  <Text style={[styles.progressValue, { fontSize: getFontSize(15), color: accentColor }]}>
          ...
          {/* Daily Goals */}
          <Card style={styles.card}>
            <Card.Title title="🎯 Daily Goals" titleStyle={[styles.cardTitle, { fontSize: getFontSize(18) }]} />
            <Card.Content>
          ...
          {/* Weight Goal */}
          <Card style={styles.card}>
            <Card.Title title="⚖️ Weight Goal" titleStyle={[styles.cardTitle, { fontSize: getFontSize(18) }]} />
            <Card.Content>
          ...
          <Card style={[styles.tipCard, { borderLeftColor: accentColor }]}>
            <Card.Content>
              <Text style={[styles.tipText, { fontSize: getFontSize(14) }]}>
                💡 Tip: Adjust your goals as you progress. Small, consistent changes lead to lasting results!
              </Text>
            </Card.Content>
          </Card>
            </>
          ...
          {activeTab === 'planner' && (
            <>
              <Card style={styles.card}>
                <Card.Title title="📅 Weekly Meal Planner" titleStyle={[styles.cardTitle, { fontSize: getFontSize(18) }]} />
                <Card.Content>
                  <View style={[styles.tipCard, { backgroundColor: colors.surfaceVariant, borderLeftColor: accentColor }]}>
                    <Text style={[styles.tipText, { fontSize: getFontSize(13), color: colors.text }]}>
                      ...
                      1️⃣ Go to <Text style={{ fontWeight: '700', color: accentColor }}>Recipes</Text> tab and find a recipe you like{'\n'}
                      2️⃣ Tap <Text style={{ fontWeight: '700', color: accentColor }}>"View Recipe"</Text> to see details{'\n'}
                      3️⃣ Click <Text style={{ fontWeight: '700', color: accentColor }}>"Add to Meal Plan"</Text> button{'\n'}
                      4️⃣ Choose which day and meal time{'\n'}
                      5️⃣ Your meal will appear here with all ingredients!
                    </Text>
                  </View>
              ...
              {/* Meal Prep Tracker */}
              <Card style={styles.card}>
                <Card.Title title="👨‍🍳 Meal Prep Tracker" titleStyle={[styles.cardTitle, { fontSize: getFontSize(18) }]} />
                <Card.Content>
                  <Text style={[styles.helpText, { fontSize: getFontSize(13), color: colors.textSecondary }]}>
        ...
        <View style={styles.exportModalOverlay}>
          <View style={[styles.exportModalContent, { backgroundColor: colors.surface, borderColor: accentColor }]}>
            ...
            <Text style={[styles.exportModalHint, { fontSize: getFontSize(11), color: colors.textTertiary }]}>
              💡 If an app isn't installed, you'll be able to share as text instead
            </Text>
          </View>
        </View>
      </Modal>
